...
interface MatchmakingModalProps {
  isOpen: boolean;
  initialTab?: 'custom' | 'quick' | 'spectate';
...
export const MatchmakingModal: React.FC<MatchmakingModalProps> = ({
  ...
  return (
    <div id="privateRoomModal" className="fixed inset-0 z-50 flex items-center justify-center bg-black/80 backdrop-blur-xl p-3 sm:p-4 animate-fadeIn overflow-y-auto">
