...
> = {
  ...
  business: {
    title: 'Tycoon Advisor AI',
    badge: 'Monopoly Strategist',
    presets: [
      { label: 'Property Acquisition ROI', query: 'Which property categories provide the highest rental return and fastest mortgage payoff?', icon: <Sparkles className="w-3.5 h-3.5 text-amber-400" /> },
      { label: 'Skyscraper Upgrade Timing', query: 'When is the optimal liquidity point to upgrade properties to Skyscraper hotels without risking bankruptcy?', icon: <Target className="w-3.5 h-3.5 text-emerald-400" /> },
    ],
  },
};
