...
export const GAME_CATALOG_DATA: GameCatalogItem[] = [
  ...
  },
  {
    ...
    category: 'board_dice',
    categoryLabel: 'SPORTS & PRECISION 🎯',
    maxPlayers: 2,
    subtitle: 'Official London Dartboard',
    ...
    badgeBg: 'bg-red-500/20 border-red-400/40',
    badgeText: 'text-red-300',
    buttonGradient: 'from-amber-500 via-red-500 to-amber-600 text-slate-950 font-black',
    cardBorder: 'hover:border-red-400/50 hover:shadow-red-950/40',
  },
  {
    id: 'pingpong',
    ...
    categoryLabel: 'SPORTS & PRECISION 🏓',
    maxPlayers: 2,
    subtitle: 'Table Tennis Rally Arena',
    description: 'Fast-paced paddle rally table tennis with 60 FPS ball physics, paddle slice curves, smash power mechanics, rally streak tracking, and AI opponent.',
    icon: '🏓',
    badgeBg: 'bg-emerald-500/20 border-emerald-400/40',
    badgeText: 'text-emerald-300',
    buttonGradient: 'from-cyan-500 via-blue-600 to-emerald-500 text-white font-black',
    cardBorder: 'hover:border-cyan-400/50 hover:shadow-cyan-950/40',
  },
  {
    id: 'business',
    num: 20,
    name: 'Business Empire Online',
    category: 'board_dice',
    categoryLabel: 'BOARD & TYCOON 👑',
    maxPlayers: 4,
    subtitle: 'Build • Invest • Trade • Become a Tycoon',
    description: 'Premier property empire board game with live market trends, asset portfolios, auctions, trading, skyscrapers, chance cards, and 3D dice rolling.',
    icon: '👑',
    badgeBg: 'bg-gradient-to-r from-amber-500/30 to-yellow-500/20 border-amber-400/50',
    badgeText: 'text-[#ffe89e]',
    buttonGradient: 'from-amber-500 via-yellow-500 to-amber-600 text-slate-950 font-black',
    cardBorder: 'hover:border-amber-400/60 hover:shadow-amber-950/50',
  },
];
