...
export const GameOptionsControlPanel: React.FC<GameOptionsControlPanelProps> = ({
  ...
  const hasAiPlayer = gameMode ? gameMode === 'ai' : playerSlots.some((s) => s.isAi);
                ...
                {playerSlots.map((slot) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <button
                        id={slot.id === 'b' ? 'blackOpponentTag' : (isUser ? 'whitePlayerTag' : 'opponentTag')}
                        disabled={isUser}
                        onClick={() => {
