  ...
  business: [
    {
      id: 'biz1',
      game: 'business',
      title: 'Monopoly Corporate Takeover',
      category: 'Financial Strategy',
      objective: 'Acquire the final Tech Hub property and upgrade to Skyscraper level 3 to bankrupt the rival tycoon on their next dice roll.',
      solution: 'Invest in Tech Hub, build 3 Skyscrapers, and collect ₹4,200 rent',
      explanation: 'Establishing a full sector monopoly maximizes rent yield and forces total opponent liquidation!',
    },
  ],
};
