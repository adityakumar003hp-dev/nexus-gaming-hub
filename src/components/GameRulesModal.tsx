      ...
      <div className="relative w-full max-w-xl max-h-[85vh] flex flex-col bg-[#11131e] border border-[#f3ce6b]/40 rounded-3xl shadow-[0_0_50px_rgba(0,0,0,0.9)] text-white overflow-hidden">
        ...
        <div className="p-6 overflow-y-auto space-y-4 text-xs text-gray-300 leading-relaxed custom-scrollbar">
          ...
          {activeGame === 'business' && (
            <div className="space-y-3">
              <div className="p-3 bg-amber-500/10 border border-amber-400/30 rounded-2xl text-amber-200 font-bold">
                Objective: Build wealth, buy prime corporate properties, collect rent, and bankrupt your rivals to become the supreme Tycoon!
              </div>
              <ul className="space-y-1.5 pl-2">
                <li>• <strong>Dice Movement:</strong> Roll the glowing 3D dice to advance clockwise around the 24-space business empire board.</li>
                <li>• <strong>Property Acquisition:</strong> Land on unowned properties (Tech Parks, IT Hubs, Airports, Food Chains) and purchase them to establish your portfolio.</li>
                <li>• <strong>Rent Collection:</strong> When opponents land on your assets, they must pay you rent. Upgrading with Skyscraper levels multiplies rent earnings exponentially!</li>
                <li>• <strong>Special Spaces:</strong> Pass <em>START</em> or <em>GO</em> to collect ₹5,000. Land on <em>CHANCE</em> for market windfalls, corporate mergers, or tax audits. Beware the <em>JAIL</em> space!</li>
                <li>• <strong>Market Trends &amp; Actions:</strong> Monitor live sector fluctuations (Tech, Real Estate, Automobile) and use <em>INVEST</em>, <em>TRADE</em>, <em>AUCTION</em>, and <em>BUILD</em> to dominate the economy.</li>
              </ul>
            </div>
          )}
        </div>
