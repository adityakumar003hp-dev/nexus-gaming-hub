      ...
      <div className="relative bg-[#070d19] border border-blue-500/40 backdrop-blur-3xl rounded-3xl max-w-2xl w-full p-6 shadow-[0_0_80px_rgba(59,130,246,0.25)] text-slate-100 space-y-6">
        ...
        <div className="flex items-center gap-2 border-b border-blue-950 pb-2 overflow-x-auto scrollbar-none text-xs font-mono font-bold">
          ...
          <button
            ...
            className="px-3.5 py-2 rounded-xl transition flex items-center gap-2 bg-emerald-950/60 hover:bg-emerald-900/80 text-emerald-300 hover:text-emerald-100 border border-emerald-500/40"
          >
            <FileText className="w-4 h-4 text-emerald-400" /> Google Forms
          </button>
        ...
        {activeTab === 'setup' && (
          <div className="bg-slate-950 border border-slate-800 rounded-2xl p-4 space-y-3 font-mono text-xs">
            ...
            <div className="p-3 bg-slate-900 rounded-xl border border-slate-800 space-y-2">
              ...
              <div>
                <span className="text-[10px] text-slate-500 uppercase block">Requested Scopes & Services</span>
                <span className="text-emerald-400 font-bold block">profile, email, openid, Google Forms API v1</span>
                <span className="text-[10px] text-slate-400 mt-0.5 block">forms.body, forms.body.readonly, forms.responses.readonly</span>
              </div>
            </div>
          </div>
        )}
