...
export const GAME_DEFEAT_MESSAGES: Record<ActiveBoardGame, GameDefeatMeta> = {
  ...
  business: {
    id: 'business',
    gameNumber: 20,
    gameName: 'Business Empire Online',
    seriesLabel: 'Series: Game 20/20',
    penaltyDescription: '10,000 points were deducted from your balance in accordance with Corporate Liquidation & Bankruptcy Regulations.',
    defaultDefeatSubtitle: 'Rival tycoon forced corporate bankruptcy through property monopoly',
  },
};
